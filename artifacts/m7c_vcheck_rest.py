...
TESTS = [("wakepolltest","wakepolltest",70),("polltest","polltest",45),("idletest","idletest 0",40),("scmtest","scmtest",45),("drmsmoke","drmsmoke",55),("evtest2","evtest2",45),("waittest","waittest",55)]
def d(*a,t=200):
