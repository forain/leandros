...
# non-software screen -> "compatible render device" fail). GALLIUM_DRIVER=softpipe
...
def main():
    ...
    setline = ("export XDG_RUNTIME_DIR=/run/user/0 COSMIC_BACKEND=kms SMITHAY_USE_LEGACY=1 "
               ...
               "RUST_LOG=info GBM_ALWAYS_SOFTWARE=1 GALLIUM_DRIVER=softpipe COSMIC_RENDER_DEVICE=226:0")
