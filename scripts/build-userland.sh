...
RELIBC_LINKED=(pthreadtest timertest sigtest polltest ptytest forktest racetest ping waittest sigchldtest epolltest wakepolltest smpwaketest idletest drmsmoke evtest2 evsplit vttest venustest)
