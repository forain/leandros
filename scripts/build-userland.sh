...
RELIBC_LINKED=(pthreadtest timertest sigtest polltest forktest racetest ping waittest sigchldtest epolltest wakepolltest idletest drmsmoke evtest2 venustest)
