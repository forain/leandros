...
RELIBC_LINKED=(pthreadtest timertest sigtest polltest ptytest forktest racetest ping waittest sigchldtest epolltest wakepolltest idletest drmsmoke evtest2 evsplit vttest venustest)
