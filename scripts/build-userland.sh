...
RELIBC_LINKED=(pthreadtest timertest sigtest polltest ptytest forktest racetest ping waittest sigchldtest sigtest2 jobtest exectest epolltest wakepolltest smpwaketest idletest drmsmoke evtest2 evsplit vttest venustest)
