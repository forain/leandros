 ...
 *     /dev/input/event1     subsystem=input  ID_INPUT_MOUSE
 *     /dev/input/event2     subsystem=input  ID_INPUT_TOUCHSCREEN
 *
...
static const struct prop props_touch[] = {
...
static const struct dev_desc g_devices[] = {
	...
	{ "/sys/class/input/input1", "input1", "1", "input", NULL, NULL, NULL,
	  0, 0, 0, 1, NULL, NULL, 0 },
	{ "/sys/class/input/input2", "input2", "2", "input", NULL, NULL, NULL,
	  0, 0, 0, 1, NULL, NULL, 0 },
	...
	{ "/sys/class/input/event2", "event2", "2", "input", NULL, "/dev/input/event2", NULL,
	  'c', 13, 66, 1, "/sys/class/input/input2", props_touch, NPROPS(props_touch) },
};
